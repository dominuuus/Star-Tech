...
export function AchievementDetailComponent({
  item,
  type,
  visible,
  setVisibility,
          ...
          <AchievementContent>
            ...
            {item.Tipo === "planet" && (
              <>
                ...
                {item.Tema_Principal && (
                  <p>
                    <strong>Tema:</strong> {item.Tema_Principal}
                  </p>
                )}
                {item.Gentilico && (
                  <p>
                    <strong>Gentílico:</strong> {item.Gentilico}
                  </p>
                )}
                {item.Qtd_missões && (
                  <p>
                    <strong>Missões:</strong> {item.Qtd_missões}
                  </p>
                )}
              </>
            )}
            ...
            {item.Tipo === "mascot" && (
              <>
                ...
                {item.Habilidade_Especial && (
                  <p>
                    <strong>Habilidade:</strong> {item.Habilidade_Especial}
                  </p>
                )}
                {item.Aparência && (
                  <p>
                    <strong>Aparência:</strong> {item.Aparência}
                  </p>
                )}
              </>
            )}
